            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <textarea name="address" id="inputAddress" class="form-control">{{ $user->address }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                        <input type="text" name="pdetails" class="form-control" id="inputParent" value="{{ $user->parent_details }}" placeholder="Parent Details">
                        </div>
                    </div>
                    <div class="form-group row">
